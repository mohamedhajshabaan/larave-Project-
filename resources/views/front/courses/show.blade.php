            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="main_image">
                        <img class="img-fluid" src="{{asset('uploads/Courses/'.$courses->img)}}" alt="Photo Not Found "></div>
                ...
                <div class="col-lg-4 right-contents">
                    ...
                    <div class="my-5">
                        ...
                        <form class="form-contact contact_form" action="{{route('front.contact')}}" method="get" id="contactForm">
                            @csrf
                            @method('POSt')
                            <div class="row">
